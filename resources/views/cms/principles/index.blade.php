...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-header">
            <a href="{{ route('principleCreate') }}" class="btn btn-primary">Add</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($sliders as $slider)
                            <tr>
                               ...
                               <td>
                                    <div class="d-flex">
                                        <a href="{{ route('principleEdit', $slider->id) }}" class="btn btn-outline-success me-2">Edit</a>
                                        <form action="{{ route('principleDelete', $slider->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
